@extends('ecommerce.navbar.nav')

@section('body')
<div class="container-fluid mb-5">
        <div class="row  border-top px-xl-5 justify-content-end">
        <div class="col-lg-9">
                <div id="header-carousel" class="carousel slide justify-content-right" data-ride="carousel">
